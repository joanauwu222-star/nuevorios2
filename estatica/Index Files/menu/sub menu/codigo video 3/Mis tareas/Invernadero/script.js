...
const pages = {
    ...
    tipos: `
        ...
        <div class="plantas-grid">
            ...
            <div class="planta-card">
                <img src="c:\Martin Chable Jenifer Joana\Index Files\Evidencias Tareas\Mis tareas\Invernadero\Mi primera página web_files\imagenes\exterior.png" alt="Plantas de exterior">
                <h4>Plantas de exterior</h4>
                <p>Resistentes al sol y a las inclemencias del tiempo. Ideales para jardines.</p>
            </div>
            <div class="planta-card">
                <img src="c:\Martin Chable Jenifer Joana\Index Files\Evidencias Tareas\Mis tareas\Invernadero\Mi primera página web_files\imagenes\flor.png" alt="Plantas con flor">
                <h4>Plantas con flor</h4>
                <p>Aportan color y alegría a cualquier espacio. Florecen en primavera.</p>
            </div>
            <div class="planta-card">
                <img src="c:\Martin Chable Jenifer Joana\Index Files\Evidencias Tareas\Mis tareas\Invernadero\Mi primera página web_files\imagenes\aromaticas.jpg" alt="Plantas aromáticas">
